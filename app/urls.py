...
from app.views.contact import CreateContactPage
from app.views.index import shop_view, shopping_cart, checkout, \
...
urlpatterns = [
    ...
    path('contact/', CreateContactPage.as_view(), name='contact'),
